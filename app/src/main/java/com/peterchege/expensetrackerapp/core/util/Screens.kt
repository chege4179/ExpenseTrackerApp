...
object Screens {
    ...
    const val ADD_EDIT_EXPENSE_CATEGORY_SCREEN ="ADD_EDIT_EXPENSE_CATEGORY_SCREEN"

    const val ADD_EDIT_TRANSACTION_CATEGORY_SCREEN ="ADD_EDIT_TRANSACTION_CATEGORY_SCREEN"
}